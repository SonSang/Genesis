...
class RigidSolver(KinematicSolver):
    ...
    def _debug_grad_dump(self, tag):
        ...
        fields = [
            ...
            # Extended set — find cross-substep leak sources hidden outside the
            # core list above.
            ("rigid_global_info.qpos_next", self._rigid_global_info.qpos_next),
            ("dofs_state.vel_prev", self.dofs_state.vel_prev),
            ("dofs_state.vel_next", self.dofs_state.vel_next),
            ("dofs_state.acc_bw", self.dofs_state.acc_bw),
            ("dofs_state.qf_actuator", self.dofs_state.qf_actuator),
            ("dofs_state.qf_constraint", self.dofs_state.qf_constraint),
            ("dofs_state.act_length", self.dofs_state.act_length),
            ("dofs_state.cdofvel_ang", self.dofs_state.cdofvel_ang),
            ("dofs_state.cdofvel_vel", self.dofs_state.cdofvel_vel),
            ("dofs_state.f_vel", self.dofs_state.f_vel),
            ("dofs_state.f_ang", self.dofs_state.f_ang),
            ("dofs_state.ctrl_force", self.dofs_state.ctrl_force),
            ("dofs_state.ctrl_pos", self.dofs_state.ctrl_pos),
            ("dofs_state.ctrl_vel", self.dofs_state.ctrl_vel),
            ("links_state.cinr_quat", self.links_state.cinr_quat),
            ("links_state.crb_quat", self.links_state.crb_quat),
            ("links_state.i_pos_bw", self.links_state.i_pos_bw),
            ("links_state.j_pos", self.links_state.j_pos),
            ("links_state.j_quat", self.links_state.j_quat),
            ("links_state.j_pos_bw", self.links_state.j_pos_bw),
            ("links_state.j_quat_bw", self.links_state.j_quat_bw),
            ("links_state.j_vel", self.links_state.j_vel),
            ("links_state.j_ang", self.links_state.j_ang),
            ("links_state.cd_ang_bw", self.links_state.cd_ang_bw),
            ("links_state.cd_vel_bw", self.links_state.cd_vel_bw),
            ("links_state.mass_sum", self.links_state.mass_sum),
            ("links_state.root_COM", self.links_state.root_COM),
            ("links_state.root_COM_bw", self.links_state.root_COM_bw),
            ("links_state.mass_shift", self.links_state.mass_shift),
            ("links_state.i_pos_shift", self.links_state.i_pos_shift),
            ("links_state.cacc_ang", self.links_state.cacc_ang),
            ("links_state.cacc_lin", self.links_state.cacc_lin),
            ("links_state.contact_force", self.links_state.contact_force),
        ]
        verbose_set = {
            ...
            "links_state.cinr_pos",
            "links_state.cinr_mass",
            "dofs_state.qf_bias",
            "dofs_state.force",
