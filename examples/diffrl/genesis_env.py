...
Mirrors the surface of NVIDIA DiffRL's `DFlexEnv` so SHAC / BPTT training
code can stay close to the reference implementation. The key methods are:
...
class GenesisDiffRLEnv(ABC):
    ...
    def step(self, actions: torch.Tensor):
        ...
        # are supported by the underlying Genesis API.
